    ...
    <div>
      ...
      <img src={Images.me2} style={{ width: '30%', marginTop: "12%", marginRight: "50%"}} />
       ...
       style={{marginLeft: "44%", width: "50%", height: "10%", textAlign: "left", marginTop: "3%", lineHeight: "1.5" }}>
        <Text>​I'm Nima, a software developer from Waterloo, Canada. I’m currently in my second year of studies in Systems Design Engineering at the University of Waterloo. Throughout my journey, ​I hope to develop and implement products and features at a wide range of companies, startups, and agencies across North America and Europe. As a developer with an engineering background,​ I've found ways to apply very technical methods to a variety of problem spaces and take ownership in various parts of the design and management processes as well. </Text>
        <Text>Outside of school you can also find me training for a half marathon that I’ll be running in October, or fuelling my creativity through painting, puzzles, or traveling!</Text>
       ...
       style={{marginLeft: "70%", width: "20%", height: "10%", textAlign: "left", marginTop: "-23.5%", lineHeight: "1.5" }}>
        <Text> Helping non-profit organizations with the use of technology and getting as involved as I can with my community!</Text>
       ...
       style={{width: "13%", height: "10%", textAlign: "left", marginLeft: "10%", marginTop: "5%"}}>
        ...
        <Text style={{marginLeft: "47.8%", marginTop: "-4.7%", fontWeight: 700}}> Volunteer Lead </Text>
        <Text style={{marginLeft: "47.5%"}}> Hack the North </Text>
        ...
        <Box
       style={{width: "45%", height: "10%", textAlign: "left", marginLeft: "9.5%", marginTop: "1.5%", lineHeight: "1.5"}}>
        ...
        <a href="path/to/your/resume.pdf" target="_blank" rel="noopener noreferrer" style={{ color: "rgb(220, 100, 52)" }}>MY RESUME</a>
      </Text>
