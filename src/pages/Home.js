...
<div style={{marginTop: "40%"}} className="grey-bar"></div>
       ...
       style={{marginLeft: "16.4%", width: "28%", height: "10%", textAlign: "left", marginTop: "1%"}}>
        ...
        Orchestrating the enhancement of software management through streamlined workflows, fortified team communication, and strategic productivity implementations
        </Text>
        </Box>
   
      <ChakraLink href="https://www.o8t.com/" isExternal>
...
<div>
       ...
       style={{marginLeft: "16.4%", width: "28%", height: "10%", textAlign: "left", marginTop: "1%"}}>
        ...
        <ChakraLink href="https://www.mappedin.com/" isExternal>
...
<div>
      ...
      <Text style={{ ...textStyles.paragraph2, color: colors.grey[100], marginTop: "4%", marginRight: "56%",}}>
       ...
       style={{marginLeft: "16.4%", width: "28%", height: "10%", textAlign: "left", marginTop: "1%"}}>
        ...
        <ChakraLink href="https://uwblueprint.org/" isExternal>
